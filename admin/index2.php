...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="index2.php" class="logo" style="background-color: #003366;">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header" style="background-color: #003366;">
                ...
                <p>
                  ...
                  <small> <?php $role="LPM"; echo "$role"; ?> </small>
                </p>
              </li>
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="../koneksi/logout_wakil_ketua.php" class="btn btn-default btn-flat" style="background-color: #003366; color: white;">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <!-- <p style="color: #fff;"><?php echo $rows['nama_wakil_ketua']; ?></p> -->
          <!-- <img src="../admin/pages/foto/wakil ketua/<?php echo $rows['foto_wakil_ketua']; ?>" class="img-circle" alt="User Image"> -->
        </div>
  ...
  <!--     <form action="#" method="get" class="sidebar-form">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="index2.php?page=hasil_audit"><i class="fa fa-circle-o"></i>Hasil Audit</a></li>
            <li><a href="index2.php?page=kontrol_audit"><i class="fa fa-circle-o"></i>Kontrol Audit</a></li>
        </li>
    ...
    switch ($page) {
      ...
      case 'olah_akun_staf':
        ...
        case 'kontrol_audit':
          ...
          case 'filter_kontrol':
            include "pages/kontrol_audit/filter.php";
            break;
