...
<head>
  ...
  <title>AMI | <?php echo $rows['nama_auditor']; ?></title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="index4.php" class="logo" style="background-color: #003366;">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="../koneksi/logout_auditor.php" class="btn btn-default btn-flat" style="background-color: #003366; color: white;">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
    ...
    <!-- <li class="treeview">
      ...
      <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="index4.php?page=jadwal"><i class="fa fa-circle-o"></i>Jadwal Audit</a></li>
            <li><a href="index4.php?page=dokumen_auditor"><i class="fa fa-circle-o"></i>Unduh Dokumen</a></li>
            <li><a href="index4.php?page=audit"><i class="fa fa-circle-o"></i>Unggah Hasil Audit</a></li>
          </ul>
        </li>
...
<!-- 
     ...
     <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="index4.php?page=hasil_audit"><i class="fa fa-circle-o"></i>Hasil Audit</a></li>
        </li>
      </ul>
    </section>
   </aside>
