...
<head>
  ...
  <title>AMI | <?php echo $rows['nama_staf']; ?></title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="index3.php" class="logo" style="background-color: #003366;">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="../koneksi/logout_staf.php" class="btn btn-default btn-flat" style="background-color: #003366; color: white;">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="">
         ...
         <li class="treeview">
          ...
          <li><a href="index3.php?page=jadwal"><i class="fa fa-circle-o"></i>Jadwal Audit</a></li>
          <li><a href="index3.php?page=standar_operasional"><i class="fa fa-circle-o"></i>Unduh Dokumen</a></li>
            <li><a href="index3.php?page=dokumen"><i class="fa fa-circle-o"></i>Unggah Dokumen</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="index3.php?page=hasil_audit"><i class="fa fa-circle-o"></i>Hasil Audit</a></li>
        </li>
