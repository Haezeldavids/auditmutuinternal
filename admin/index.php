...
<head>
  ...
  <title>AMI | <?php echo $rows['nama']; ?></title>
...
<div class="wrapper">
  ...
  <header class="main-header" >
    <!-- Logo -->
    <a href="index.php" class="logo" style="background-color: #003366;">
    ...
    <nav class="navbar navbar-static-top " style="background-color: #003366;">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header" style="background-color: #003366;">
                ...
                <p>
                  <?php echo $rows['nama']; ?>
                  <small> <?php $role="admin"; echo "$role"; ?> </small>
                </p>
              </li>
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="../koneksi/logout.php" class="btn btn-default btn-flat" style="background-color: #003366; color: white;">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
  ...
  <!--     <form action="#" method="get" class="sidebar-form">
    ...
    <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="index.php?page=data_wakil_ketua"><i class="fa fa-circle-o"></i> User</a></li>
            <li><a href="index.php?page=akun_wakilketua"><i class="fa fa-circle-o"></i>Kelola Akun User</a></li>
            ...
            <li><a href="index.php?page=jadwal"><i class="fa fa-circle-o"></i>Jadwal Audit</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="index.php?page=standar_nasional"><i class="fa fa-circle-o"></i>Standar Nasional</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="index.php?page=standar_operasional"><i class="fa fa-circle-o"></i>Unggah Dokumen</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
             <li><a href="index.php?page=hasil_audit"><i class="fa fa-circle-o"></i>Hasil Audit</a></li>
             <li><a href="index.php?page=kontrol_audit"><i class="fa fa-circle-o"></i>Kontrol Audit</a></li>
