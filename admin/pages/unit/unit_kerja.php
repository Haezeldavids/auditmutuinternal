    ...
    <div class="col-xs-12">
      ...
      <div class="box">
        <div class="box-header" style="background-color: #003D6B;">
          <h3 class="box-title" style="font-family: verdana; color: white;">Data Table Program Studi</h3>
        </div>
        <div class="row">
        ...
        <div class="box-body table-responsive">
          <table id="example1" class="display nowrap table-responsive table-striped" style="width:100%">
            <thead>
              <tr>
                <th>No</th>
                <th>Kode Progam Studi</th>
                <th>Program Studi</th>
                <th>Nama Koorprodi</th>
            ...
            <tbody>
              ...
              $no_urut = 0;
              $query = mysqli_query($connect, "SELECT * FROM unit_kerja,staf WHERE unit_kerja.id_jbt = staf.id");
              ...
              ?>
                  ...
                  <td>
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a href="#edit_modal_unit_kerja<?php echo $no_urut ?>" data-toggle='modal' data-id="<?php echo $no_urut ?>">Edit</a></li>
                        <li><a href="" data-toggle="modal" data-target="#konfirmasi_hapus_unit_kerja_<?= $rows['kode_unit'] ?>">Delete</a></li>
                        <!-- <li class="divider"></li>
                ...
                <div class="modal fade" id="edit_modal_unit_kerja<?php echo $no_urut ?>" role="dialog">
                        ...
                        <form action="pages/config/unit_kerja_edit.php" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
                          <div class="hasil-data">
                            <div class="form-group">
                              ...
                              <input type="text" name="kode_unit" class="form-control" placeholder="kode unit" value="<?= $rows['kode_unit'] ?>" readonly>
                            </div>

                            <div class="form-group">
                              <label for="">Program studi</label>
                              <input type="text" name="nama_unit" class="form-control" placeholder="nama unit" value="<?= $rows['nama_unit'] ?>">
                            </div>

                            <div class="form-group">
                              <label for="">Nama Koorprodi</label>
                              <input type="text" name="nama_staf" class="form-control" placeholder="nama staf" value="<?= $rows['nama_staf'] ?>" readonly>
                            </div>
                          </div>
                ...
                <div class="modal fade" id="konfirmasi_hapus_unit_kerja_<?= $rows['kode_unit'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                  <div class="modal-dialog" style="margin-top: 15%;">
                    <div class="modal-content" style="margin-top: 100px;">
                      ...
                      <div class="modal-footer" style="margin:0px; border-top:0px; text-align:center;">
                        <a class="btn btn-danger btn-ok" href="pages/config/delete_unit_kerja.php?kode_unit=<?= $rows['kode_unit'] ?>"> Hapus</a>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Masukan Data Program Studi</h4>
        </div>
        <div class="modal-body">
            ...
            <div class="row">
              ...
              <div class="col-md-9">
                <div class="form-group">
                  ...
                  <label for="kode_unit">Kode Program Studi</label>
                ...
                <div class="form-group">
                  ...
                  <select name="id_staf" id="id_jbt" class="form-control">
                    <option>--Koorprodi--</option>
                    <?php
                    //Mengambil nama jabatan dalam Database
                    $jabatan = mysqli_query($connect, "SELECT * from staf order by nama_staf ASC");
