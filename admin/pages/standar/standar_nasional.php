        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header" style="background-color: #003D6B;">
              <h3 class="box-title" style="font-family: verdana; color: white;">Data Table Standar Nasional</h3>
            </div>
            <div class="row">
               ...
               <div class="row">
                    ...
                    <div class="col-md-9">
                         <div class="form-group">
                              ...
                              <input type="text" required class="form-control" name="kode_sn" id="kode_sn" placeholder="Masukan Kode Standar Nasional">   
                          </div>
                          <div class="form-group">
                            <label for="nama_sn">Nama Standar Nasional</label>
                            <input type="text" required class="form-control" name="nama_sn" id="nama_sn" placeholder="Masukan Nama Standar Nasional">
                          </div>
